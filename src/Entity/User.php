...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: WorkflowSubject::class, mappedBy: 'assignedTo')]
    ...
    public function addAssignedSubject(WorkflowSubject $assignedSubject): static
    {
        if (!$this->assignedSubjects->contains($assignedSubject)) {
            $this->assignedSubjects->add($assignedSubject);
            $assignedSubject->setAssignedTo($this);
        }

        return $this;
    }

    public function removeAssignedSubject(WorkflowSubject $assignedSubject): static
    {
        if ($this->assignedSubjects->removeElement($assignedSubject)) {
            // set the owning side to null (unless already changed)
            if ($assignedSubject->getAssignedTo() === $this) {
                $assignedSubject->setAssignedTo(null);
            }
        }
